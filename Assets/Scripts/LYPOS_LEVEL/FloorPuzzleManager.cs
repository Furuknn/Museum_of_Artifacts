...
public class FloorPuzzleManager : MonoBehaviour, IInteractable
{
    ...
    {
        // 1. Buton say�s� kadar bir say� listesi olu�tur (1, 2, 3...)
        ...
        // 2. Say� listesini rastgele kar��t�r (Fisher-Yates Algorithm)
        ...
        // 3. Kar��t�r�lm�� say�lar� butonlara ata
        for (int i = 0; i < buttons.Count; i++)
        {
            buttons[i].InitializeButton(numbers[i]);

            // G�rsel geri bildirim i�in buton �zerindeki yaz�y� g�ncelleyebilirsin
            // buttons[i].UpdateUI(); 
        }

        Debug.Log("Buton numaralar� ba�ar�yla kar��t�r�ld�!");
    }
